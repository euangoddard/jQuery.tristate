    ...
    var self = {
        init: function () {
            ...
            return this.each(function () {
                ...
                if (!initial_state) {
                    initial_state = $checkbox.prop('checked') ?
        ...
        _set_state: function (new_state) {
            ...
            switch (state_to_set) {
                case $.tristates.unchecked:
                    $checkboxes.prop('checked', false).css({opacity: 1});
                    break;
                case $.tristates.checked:
                    $checkboxes.prop('checked', true).css({opacity: 1});
                    break;
                case $.tristates.mixed:
                    $checkboxes.prop('checked', true).css({opacity: mixed_opacity});
                    break;
            }
        ...
        _debug: function (message) {
            ...
            window.console && window.console.debug.apply(window.console, arguments);
        }
    },
    mixed_opacity = 0.5;
